...
export const defaultData = (
    ...
    const availableUserConfigurations = availableConfigurations.filter(availableConfig =>
        userGroupIds.some(userGroupId => userGroupId === availableConfig.userGroupIds[0])
    );
    ...
    return [
        ...
        ...availableUserConfigurations.map(({ programme, description, icon }) => ({
            key: programme,
            title: description,
            icon,
            rowLength: 3,
